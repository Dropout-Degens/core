...
Dax shared that he's been interning with Layup for almost a year, starting around March 2025. It's a paid internship. Through Layup, he's been exposed to startup terminology and has spoken to many bettors. He noted that bettors often have strategies and resources but no place to discuss them — they just tail picks in Discords and blame the tipsters when things go wrong.
...
- **Year 3 (current):** Community is dead. Repositioning to be education-first. The goal is not just to send profitable picks but to teach members how to use resources and understand the strategies behind picks.
...
Dax explained the customer LTV model:

- Current LTV per customer: approximately $1,400 across all partnership CPAs (deposit-based payouts)
...
- Potential paid acquisition: $1-5 per customer via Meta ads once conversion funnel is validated
- Only need a low conversion rate to be profitable given the LTV

## Growth Strategy

Dax outlined three approaches:

1. **Community re-engagement:** Not a priority. The existing demographic (Fliff users who don't really know how to bet) has already churned. They'll naturally re-engage over time as the server gets more active.
2. **Community acquisition:** Actively pursuing. Dax is in talks with communities to merge. The deal structure is a percentage of Dropout Degens revenue (4-5%) rather than a cash buyout. This brings members, analysts, and mods.
3. **Paid acquisition (Meta ads):** Not until product-market fit is validated. Need to prove return on ad spend before scaling.

Dax mentioned wanting 20 daily active members chatting before focusing on social media and paid marketing — the server needs to have something for new members to come into.

## Staff and Compensation Structure

Dax explained the current breakdown:

- **20% of revenue** goes to a bonus fund (covers operating costs, marketing budget, with Dax covering any negative balance out of pocket)
- **10% for head staff:** JP, Dante, and developer Zach. Dante may not be sticking around.
- **10% for analysts:** Each analyst gets around 1-2% revenue share
- **5% staff bonus:** Point-based system. Staff earn points for conversions (getting members to sign up for partners using DD's code) and invites (tracked invite links). Points translate to a proportional share of the 5% pool.
- **Double points:** If a staff member both invites someone and converts them, they get points for both.

Operating costs are minimal — sub-$50/month for Google Cloud hosting and AI subscriptions.

Dax noted compensation hasn't been going well because revenue is low and analysts weren't focused on conversions, just on sending picks. The 5% bonus is a new incentive structure to encourage the education-first approach and drive partnership conversions.

## Tools and Integrations

Dax mentioned several tools:

- **Props Cache bot:** Shows last five plays, integrated into Discord
- **Outlier Insights:** Sends daily trends
- **OddsJam EV:** Collecting data for about two years (2,000+ alerts per day). Building filters on top of OddsJam's algorithm to identify high-performing markets. Goal is to send 5-10 best plays daily based on when OddsJam's 60% confidence predictions actually hit 80% of the time.
